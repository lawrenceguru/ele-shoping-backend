defmodule LetzellWeb.IntegrationCase do
  ...
  using do
    quote do
      ...
      import Letzell.Factory
      import LetzellWeb.IntegrationCase
    end
  end

  setup tags do
    :ok = Ecto.Adapters.SQL.Sandbox.checkout(Letzell.Repo)

    unless tags[:async] do
      Ecto.Adapters.SQL.Sandbox.mode(Letzell.Repo, {:shared, self()})
    end

    metadata = Phoenix.Ecto.SQL.Sandbox.metadata_for(Letzell.Repo, self())
