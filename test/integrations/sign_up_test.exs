defmodule LetzellWeb.Integrations.SignUpTest do
  ...
  describe "when user is sign up" do
    test "with successful", %{session: session} do
      current_session =
        ...
        |> fill_in(text_field("Email"), with: "jose@letzell.com")
        ...
        |> assert_eq(css("h1.title"), text: "Bienvenue sur Letzell !")
        |> assert_eq(css(".confirmation-instruction > p > strong"), text: "jose@letzell.com")
