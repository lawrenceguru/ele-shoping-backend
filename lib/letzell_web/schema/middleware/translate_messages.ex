defmodule LetzellWeb.Schema.Middleware.TranslateMessages do
  ...
  defp translate_message(%Kronky.ValidationMessage{} = validation_message) do
    ...
    Map.update!(validation_message, :message, fn _message ->
      if count = opts[:count] do
        Gettext.dngettext(LetzellWeb.Gettext, "errors", template, template, count, opts)
      else
        Gettext.dgettext(LetzellWeb.Gettext, "errors", template, opts)
      end
    end)
  end
end
