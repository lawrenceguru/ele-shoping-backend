defmodule LetzellWeb.AuthToken do
  ...
  """
  def sign(user) do
    Phoenix.Token.sign(LetzellWeb.Endpoint, @user_salt, %{id: user.id})
  end
  ...
  """
  def verify(token) do
    Phoenix.Token.verify(LetzellWeb.Endpoint, @user_salt, token, max_age: 365 * 24 * 3600)
  end
end
